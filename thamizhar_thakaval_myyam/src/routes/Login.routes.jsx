...
import Landing from "../pages/TamilMatrimony/Carousel-Section/landing"
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/Matrimony/forgetPassword"
          exact
          element={<ForgetPassword />}
        />
        <Route path="/Matrimony/home" exact element={<Home />} />
        <Route path="/Matrimony/register" exact element={<Register />} />
        <Route path="/Matrimony/details" exact element={<Details />} />
        <Route path="/Matrimony/edit_details" exact element={<EditDetails />} />
        <Route path="/Matrimony/about" exact element={<About />} />
        <Route
          path="/Matrimony/vision_and_mission"
          exact
          element={<Mission />}
        />

        ...
        <div className="matrimony_detail_left">
          <div className="matrimony_detail_left_box">
            <div className="matrimony_detail_left_box_upper">
              <img
                className="matrimony_detail_card_image"

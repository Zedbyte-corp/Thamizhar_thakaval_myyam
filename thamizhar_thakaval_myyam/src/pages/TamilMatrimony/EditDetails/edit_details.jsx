...
function EditDetails() {
  ...
  const {
    ...
    initialValues: {
      ...
      fathers_occupation: list.fathers_occupation,
      mothers_name: list.mothers_name,
      mothers_occupation: list.mothers_occupation,
      fathers_native_place: list.fathers_native_place,
      mothers_native_place: list.mothers_native_place,
      number_of_sibiling: "0",
      first_sibiling_name: list.first_sibiling_name,
      first_sibiling_occupation: list.first_sibiling_occupation,
      first_sibiling_maritial_status: list.first_sibiling_maritial_status,
      second_sibiling_name: list.second_sibiling_name,
      second_sibiling_occupation: list.second_sibiling_maritial_status,
      second_sibiling_maritial_status: list.second_sibiling_maritial_status,
      third_sibiling_name: list.third_sibiling_name,
      ...
      academic_qualification: list.academic_qualification,
      last_studied_institution: list.last_studied_institution,
      ...
      complexion: list.complexion,
      profile: list.profile,
      horoscope: list.heroscope,
    },
                  ...
                  <div>
                    ...
                    <div className="matrimony_register_label_input">
                      ...
                      <select
                        ...
                        value={list.first_sibiling_maritial_status}
                  ...
                  <div>
                    ...
                    <div className="matrimony_register_label_input">
                      ...
                      <select
                        ...
                        value={list.second_sibiling_maritial_status}
                  ...
                  <div>
                    ...
                    <div className="matrimony_register_label_input">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        value={list.third_sibiling_name}
                      />
                    ...
                    <div className="matrimony_register_label_input">
                      ...
                      <select
                        ...
                        value={list.third_sibiling_maritial_status}
                    ...
                    <div className="matrimony_register_label_input">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        value={list.third_sibiling_occupation}
                      />
              ...
              <div className="matrimony_register_align_form">
                <div className="matrimony_register_label_input">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    value={list.academic_qualification}
                  />
                ...
                <div className="matrimony_register_label_input">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    value={list.last_studied_institution}
                  />
                ...
                <div className="matrimony_register_label_input">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    value={list.annual_gross_income}
                  />
